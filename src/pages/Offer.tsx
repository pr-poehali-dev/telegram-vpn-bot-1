      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="space-y-6 border border-border rounded-sm bg-card divide-y divide-border">
          ...
          <Section title="2. Услуга и стоимость">
            <p>Тариф: <strong>Базовый — 100 ₽ в месяц</strong>.</p>
            <ul>
          ...
          <Section title="3. Автоплатежи — условия">
            <p>При оформлении подписки пользователь соглашается на <strong>автоматическое списание</strong> 100 ₽ каждые 30 дней с привязанного способа оплаты.</p>
            <ul>
