...
def send_instruction(chat_id, message_id):
    text = (
        ...
        "*iPhone / iPad:*\n"
        "1. Установи [v2rayTun](https://apps.apple.com/app/v2raytun/id6476628951) из App Store\n"
        "2. Нажми + → вставь ключ → Сохрани\n"
        "3. Нажми Connect\n\n"
        "*Android:*\n"
        "1. Установи [v2rayTun](https://play.google.com/store/apps/details?id=com.v2raytun.android) из Google Play\n"
...
def handle_update(update: dict):
    ...
    if text == "/start":
        ...
        send_message(chat_id, (
            ...
            "_Редакция от 14 апреля 2026 г._\n\n"
            "*1. Предмет оферты*\n"
            "Настоящая оферта — официальное предложение на оказание услуг доступа к VPN-сервису на условиях ежемесячной подписки.\n"
            "Оплата подписки означает полное принятие условий оферты.\n\n"
            "*2. Услуга и стоимость*\n"
            "Тариф: Базовый — 100 ₽ в месяц.\n"
            "• Безлимитный трафик\n"
            "• Высокая скорость соединения\n"
            "• Протокол VLESS Reality\n"
            "• Доступ к ключу через @RossoVPN\\_bot\n"
            "Доступ предоставляется сразу после оплаты.\n\n"
            "*3. Автоплатежи*\n"
            "При оформлении подписки вы соглашаетесь на автоматическое списание 100 ₽ каждые 30 дней.\n"
            "• За 3 дня до списания придёт уведомление в боте\n"
            "• Если списание не прошло — доступ приостанавливается\n"
            "• Данные карты хранятся в защищённой системе ЮKassa\n\n"
            "*4. Отключение автоплатежа*\n"
            "Отключить: команда /cancel в боте или обратитесь в поддержку.\n"
            "Подписка продолжает действовать до конца оплаченного периода.\n\n"
            "*5. Возврат средств*\n"
            "Возврат в течение 7 дней, если ключ не использовался.\n"
            "Поддержка: @btb75 или @makarevichas\n\n"
            "*6. Ответственность*\n"
            "Доступность сервиса — не менее 95% времени в месяц.\n"
            "Пользователь обязуется не использовать VPN в противоправных целях.\n\n"
            "*7. Прочее*\n"
            "Исполнитель вправе изменять условия с уведомлением за 7 дней.\n"
            "Вопросы: @btb75 · @makarevichas"
        ))
